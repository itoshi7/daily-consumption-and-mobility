...
ここで![x_t, S_t, D_i (t), u_t](https://render.githubusercontent.com/render/math?math=%5Cdisplaystyle+x_t%2C+S_t%2C+%5Cphi+%28t%29%2C+u_t)がデータ、潜在的な状態、曜日のダミー変数、誤差項をそれぞれ表している。![$a, b, \phi_i, \pi_{11}, \pi_{22}, \sigma$](https://render.githubusercontent.com/render/math?math=%5Cdisplaystyle+%24a%2C+b%2C+%5Cphi_i%2C+%5Cpi_%7B11%7D%2C+%5Cpi_%7B22%7D%2C+%5Csigma%24)は最尤推定法によって推定を行う。
